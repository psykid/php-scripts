<?php
    $youtube_email = "preetamnaga5@gmail.com"; // Change this to your youtube sign in email.
    $youtube_password = "PREETAMnaga5@"; // Change this to your youtube sign in password.
    // Developer key: Get your key here: http://code.google.com/apis/youtube/dashboard/.
    $key = "AI39si7BxVG6nsuVwVKvKQckSWyV_FOQ2_cJ9gFzdyK_-_sD6JSti2QV9NnheoGsnEwSNbPFO9DAiMHINJ-dPWlLbo7sxlAkHA"; 
    
    $source = 'NEWSID'; // A short string that identifies your application for logging purposes.
